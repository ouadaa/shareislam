...
function PagePlayer() {
  ...
  var self = this,
      ...
      isTouchDevice = (ua.match(/ipad|ipod|iphone|droid|android/i)),
      cleanup;
  ...
  this.config = {
    ...
    useWaveformData: true, // [Flash 9 only]: enable sound spectrum (raw waveform data) - WARNING: CPU-INTENSIVE: may set CPUs on fire.
    ...
    emptyTime: 'تحميل',      // null/undefined timer values (before data is available)
